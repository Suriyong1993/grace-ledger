...
**Root Cause**: UI is designed for accountants (Dr/Cr mental model), but staff are not accountants. They think in *events* (receive money, pay bills), not accounting mechanics.
...
**Hypothesis**  
Finance staff conceptualize financial actions as *events* ("Sunday offering received ฿15,000"), not accounting transactions ("Debit Cash, Credit Offering Income").
...
**Hypothesis**  
System can enforce double-entry bookkeeping *invisibly*. Staff records event ("รับเงิน ฿15,000"), system auto-generates balanced journal entry (Dr. Cash, Cr. Offering).
...
If staff don't understand *how* double-entry works, do they trust the system?
