...
| 0.6 | ⬜ รัน verification commands และ fix errors | ⬜ รอทำ | 30 นาที |
...
| # | งาน | สถานะ | ประมาณเวลา |
|---|-----|-------|------------|
| 1.1 | ⬜ ตรวจสอบ Dashboard ปัจจุบัน — อะไรทำงานได้/ไม่ได้ | ⬜ | 15 นาที |
| 1.2 | ⬜ แสดงยอดเงินสดคงเหลือ (ตัวใหญ่) | ⬜ | 1 ชั่วโมง |
| 1.3 | ⬜ แสดงรายรับ/รายจ่ายเดือนนี้ | ⬜ | 1 ชั่วโมง |
| 1.4 | ⬜ แสดงรายการรออนุมัติ (Action Required) | ⬜ | 1 ชั่วโมง |
| 1.5 | ⬜ แสดง Recent Transactions (5 รายการล่าสุด) | ⬜ | 1 ชั่วโมง |
| 1.6 | ⬜ เปรียบเทียบกับสัปดาห์/เดือนก่อน (% change) | ⬜ | 2 ชั่วโมง |
...
|-------|----------|-----------|-------|
| Phase 0 — Foundation | 6 | 5 | 1 |
| Phase 1 — Dashboard | 6 | 0 | 6 |
