                  ...
                  data: [
                    {
                      ...
                      direction: "income",
                      status: "posted",
                      transaction_splits: [{ fund_id: "fund-1", amount: 124500, category_id: "cat-1", categories: { id: "cat-1", name: "เงินถวายสิบลด" }, funds: { id: "fund-1", name: "กองทุนทั่วไป" } }],
                    },
                    {
                      id: "txn-2",
                      amount: 65000,
                      direction: "expense",
                      status: "posted",
                      transaction_splits: [{ fund_id: "fund-1", amount: -65000, category_id: "cat-2", categories: { id: "cat-2", name: "ค่าตอบแทนและพันธกิจผู้รับใช้" }, funds: { id: "fund-1", name: "กองทุนทั่วไป" } }],
                    },
                  ],
                  error: null,
                }),
