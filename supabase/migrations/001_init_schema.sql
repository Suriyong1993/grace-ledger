...
CREATE UNIQUE INDEX idx_users_church_name ON users(church_id, name) WHERE is_active = true;
...
CREATE INDEX idx_coa_church_active ON chart_of_accounts(church_id, is_active) WHERE is_active = true;
CREATE INDEX idx_coa_account_type ON chart_of_accounts(church_id, account_type);
CREATE INDEX idx_coa_parent ON chart_of_accounts(church_id, parent_id);
...
CREATE INDEX idx_funds_church_active ON funds(church_id, is_active) WHERE is_active = true;
...
CREATE INDEX idx_fp_status ON fiscal_periods(church_id, status);
...
CREATE INDEX idx_je_posting_date ON journal_entries(church_id, posting_date);
CREATE INDEX idx_je_status ON journal_entries(church_id, status);
CREATE INDEX idx_je_fund ON journal_entries(church_id, fund_id);
...
CREATE INDEX idx_jel_account ON journal_entry_lines(church_id, account_id);
CREATE INDEX idx_jel_fund ON journal_entry_lines(church_id, fund_id);
...
CREATE UNIQUE INDEX uq_gl_journal_line ON general_ledger(journal_line_id);
CREATE INDEX idx_gl_church_account_date ON general_ledger(church_id, account_id, posting_date);
CREATE INDEX idx_gl_church_fund_date ON general_ledger(church_id, fund_id, posting_date);
...
CREATE INDEX idx_ocs_church_date ON offering_count_sheets(church_id, date);
CREATE INDEX idx_ocs_status ON offering_count_sheets(church_id, status);
...
CREATE INDEX idx_oc_active ON offering_categories(church_id, is_active) WHERE is_active = true;

-- ============================================================================
-- Offering Subcategories
-- ============================================================================

CREATE TABLE offering_subcategories (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_offering_church_date ON offerings(church_id, date);
CREATE INDEX idx_offering_category ON offerings(church_id, category_id);
CREATE INDEX idx_offering_fund ON offerings(church_id, fund_id);
...
CREATE INDEX idx_income_church_date ON incomes(church_id, date);
CREATE INDEX idx_income_status ON incomes(church_id, status);
...
CREATE INDEX idx_expense_church_date ON expenses(church_id, date);
CREATE INDEX idx_expense_status ON expenses(church_id, status);
...
CREATE INDEX idx_audit_church ON audit_log(church_id, created_at);
CREATE INDEX idx_audit_entity ON audit_log(church_id, entity, entity_id);
