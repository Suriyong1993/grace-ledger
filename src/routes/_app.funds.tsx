                ...
                <Card className="rounded-3xl overflow-hidden">
                  <CardHeader className="flex flex-row items-start justify-between">
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">ยอดตั้งต้น {thb(f.openingBalance)}</p>
                    </div>
                  ...
                  <CardContent>
                    <p className="text-3xl font-bold tracking-tight text-foreground">{thb(balance)}</p>
                    <p className="text-xs text-muted-foreground">ยอดคงเหลือปัจจุบัน</p>
                    <div className="grid grid-cols-2 gap-2 mt-4">
                      <div className="rounded-2xl bg-success/10 p-3">
                        <div className="flex items-center gap-1 text-xs text-success"><TrendingUp className="h-3 w-3" /> รายรับ</div>
                        <p className="mt-1 font-semibold text-foreground text-sm">{thb(income + offering)}</p>
                      </div>
                      <div className="rounded-2xl bg-destructive/10 p-3">
                        <div className="flex items-center gap-1 text-xs text-destructive"><TrendingDown className="h-3 w-3" /> รายจ่าย</div>
