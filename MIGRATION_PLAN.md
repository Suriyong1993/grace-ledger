    ...
    for (const offering of input.data.offerings) {
      ...
      await createJournalEntry(tx, {
        ...
        lines: [
          ...
          {
            accountId: getIncomeAccount(offering.categoryId),
            type: "credit",
