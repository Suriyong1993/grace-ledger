...
*Every business rule in this document maps to one or more findings from the BUSINESS_DOMAIN_AUDIT.md. Rules are enforced at the server layer — never trusted to the client.*